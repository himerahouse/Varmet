...
const content = {
  en: {
    ...
    description: "We specialize in delivering innovative, high-quality products and services tailored to the needs of businesses across various sectors. At VARMET, we are committed to excellence, sustainability, and customer satisfaction.",
    cta: "Contact us",
    
    solutionTitle: "Solutions",
    solutionDescription: "At VARMET, we provide a wide array of industrial and environmental solutions tailored to meet the unique needs.",
    solutionLink: "Learn more",
    
    productionTitle: "Production",
    productionDescription: "Innovative and sustainable manufacturing solutions tailored to optimize efficiency and quality.",
    productionLink: "View our work",
    
    consultationTitle: "Free Consultation",
    consultationDescription: "Get expert advice for your industrial needs. Our team is ready to help you find the perfect solution.",
  ...
  bg: {
    ...
    description: "Ние сме специализирани в предоставянето на иновативни, висококачествени продукти и услуги, съобразени с нуждите на бизнеса в различни сектори. Във VARMET сме ангажирани с високи постижения, устойчивост и удовлетвореност на клиентите.",
    cta: "Свържете се с нас",
    
    solutionTitle: "Решение",
    solutionDescription: "Във VARMET предлагаме широка гама от индустриални и екологични решения, съобразени с уникалните нужди.",
    solutionLink: "Научете повече",
    
    productionTitle: "Производство",
    productionDescription: "Иновативни и устойчиви производствени решения, съобразени с оптимизиране на ефективността и качеството.",
    productionLink: "Вижте нашата работа",
    
    consultationTitle: "Безплатна консултация",
    consultationDescription: "Получете експертни съвети за вашите индустриални нужди. Нашият екип е готов да ви помогне да намерите перфектното решение.",
    phone: "+359 890 99 88 27",
        ...
        <div className="relative z-10 container mx-auto px-6 py-20 md:py-28 lg:py-32">
          <div className="flex flex-col">
            ...
            <div className={`text-white max-w-3xl mb-20 transition-all duration-700 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
              ...
              {/* Enhanced paragraph */}
              <p className={`text-xl text-white/80 leading-relaxed max-w-2xl mb-12 font-light ${language === 'bg' ? 'tracking-wide' : ''}`}>
                {t.description}
              </p>
